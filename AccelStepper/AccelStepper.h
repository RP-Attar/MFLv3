...
public:
    ...
    AccelStepper(u_int8_t interface = AccelStepper::FULL4WIRE, u_int8_t pin1 = 2, u_int8_t pin2 = 3, u_int8_t pin3 = 4, u_int8_t pin4 = 5, bool enable = true);
    ...
    /// \sa setPinsInverted
    void    setEnablePin(u_int8_t enablePin = 0xff);
...
protected:
    ...
    virtual void   setOutputPins(u_int8_t mask);
...
private:
    ...
    u_int8_t        _interface;          // 0, 1, 2, 4, 8, See MotorInterfaceType
